...
/// closing.
// @lfy def/parser/traits.lfy:9
pub const BRACKETS: &[(Entity, Entity)] = &[
    (Entity::Punctuation(Punctuation::GroupOpen), Entity::Punctuation(Punctuation::GroupClose)), // @lfy def/parser/traits.lfy:10
    (Entity::Punctuation(Punctuation::ListOpen), Entity::Punctuation(Punctuation::ListClose)), // @lfy def/parser/traits.lfy:10
    ...
    (Entity::Literal(Literal::ReferenceOpen), Entity::Literal(Literal::ReferenceClose)), // @lfy def/parser/traits.lfy:11
];
...
pub fn sweep_end(tokens: &[Token], start: usize, sync: &[Entity]) -> usize {
    ...
    for (index, token) in tokens.iter().enumerate().skip(start) {
        ...
        if closes_bracket(rule) {
            ...
            depth -= 1; // @lfy def/parser/traits.lfy:16
